...
function VilaCardBig(props) {
    return (
        <Link to={`stays/${props.linkto}`}>
            <div className="p-0 w-full md:h-64 h-40 bg-red-50 rounded-3xl text-center overflow-hidden relative hover:-translate-y-1 hover:shadow-2xl duration-300 ">
