...
class VillaResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'kitchen_appliances_options'       => $this->kitchen_appliances_option,
            'entertainment_facilities_options' => $this->entertainment_facilities_option,
            'welfare_amenities_options'        => $this->welfare_amenities_option,
